...
public:
    Resistor(const string& name, const string& n1, const string& n2, const string& val) : Component(name, n1, n2, val) {}
...
public:
    Capacitor(const string& name, const string& n1, const string& n2, const string& val) : Component(name, n1, n2, val) {}
    string to_netlist_string() const override;
    void stamp(Circuit& circuit, vector<vector<double>>& G, vector<vector<double>>& B, vector<vector<double>>& C, vector<vector<double>>& D, vector<double>& J, vector<double>& E, map<string, int>& m, double h, const vector<double>& p) override;
};
...
public:
    Inductor(const string& name, const string& n1, const string& n2, const string& val) : Component(name, n1, n2, val) {}
    string to_netlist_string() const override;
    void stamp(Circuit& circuit, vector<vector<double>>& G, vector<vector<double>>& B, vector<vector<double>>& C, vector<vector<double>>& D, vector<double>& J, vector<double>& E, map<string, int>& m, double h, const vector<double>& p) override;
};
...
public:
    VoltageSource(const string& name, const string& n1, const string& n2, const string& val) : Component(name, n1, n2, val) {}
    string to_netlist_string() const override;
    void stamp(Circuit& circuit, vector<vector<double>>& G, vector<vector<double>>& B, vector<vector<double>>& C, vector<vector<double>>& D, vector<double>& J, vector<double>& E, map<string, int>& m, double h, const vector<double>& p) override;
};
...
public:
    CurrentSource(const string& name, const string& n1, const string& n2, const string& val) : Component(name, n1, n2, val) {}
    string to_netlist_string() const override;
    void stamp(Circuit& circuit, vector<vector<double>>& G, vector<vector<double>>& B, vector<vector<double>>& C, vector<vector<double>>& D, vector<double>& J, vector<double>& E, map<string, int>& m, double h, const vector<double>& p) override;
};
...
string VoltageSource::to_netlist_string() const { ostringstream oss; oss << name << " " << node1_name << " " << node2_name << " " << value; return oss.str(); }
...
void Parser::handle_add_component(const vector<string>& args, Circuit& circuit) {
    if (args.size() < 4) throw runtime_error("Insufficient arguments. Usage: <name> <node1> <node2> <value>");
    string name = args[0]; char type_char = toupper(name[0]); string n1 = args[1]; string n2 = args[2]; string val_str = args[3];
    switch(type_char) {
        case 'R': circuit.add_component(make_unique<Resistor>(name, n1, n2, val_str)); break;
        case 'V': circuit.add_component(make_unique<VoltageSource>(name, n1, n2, val_str)); break;
        case 'I': circuit.add_component(make_unique<CurrentSource>(name, n1, n2, val_str)); break;
        case 'C': circuit.add_component(make_unique<Capacitor>(name, n1, n2, val_str)); break;
        case 'L': circuit.add_component(make_unique<Inductor>(name, n1, n2, val_str)); break;
